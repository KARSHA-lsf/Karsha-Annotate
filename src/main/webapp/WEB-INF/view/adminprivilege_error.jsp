<%-- 
   ...
   along with this program.  If not, see <http://www.gnu.org/licenses/>
    ...
    Document   : adminprivilege_error
    Created on : Apr 30, 2012, 9:56:55 AM
    Author     : Kasun Perera
--%>
...
<div id="indexRightColumn">
    ...
    <h1>No Admin Privilege</h1>
    <%
//Showing message that data is success full aster full markup cycle
     
    String no_admin_privilege =   (String)session.getAttribute("admin_privilage_message");
    if(no_admin_privilege !=null)
        {

        
            %>
                
                <h2 style="color:red;"><%=no_admin_privilege%></h2>
                
            
            <%
           session.setAttribute("no_admin_privilege", null); 
        }
%>
